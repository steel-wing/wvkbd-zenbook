...
#define KBD_PIXEL_HEIGHT 600

/* how tall the keyboard should be by default (can be overriden) */
#define KBD_PIXEL_LANDSCAPE_HEIGHT 400

// make && sudo cp wvkbd-zenbook /usr/bin/wvkbd-zenbook && wvkbd-zenbook -L 600
...
static struct layout layouts[NumLayouts] = {
  ...
  [Special] = {keys_special, "latin", "special", true},
  [ComposeA] = {keys_compose_a, "latin", "latin", false},
  [ComposeE] = {keys_compose_e, "latin", "latin", false},
  [ComposeY] = {keys_compose_y, "latin", "latin", false},
  [ComposeU] = {keys_compose_u, "latin", "latin", false},
  [ComposeI] = {keys_compose_i, "latin", "latin", false},
  [ComposeO] = {keys_compose_o, "latin", "latin", false},
  [ComposeW] = {keys_compose_w, "latin", "latin", false},
  [ComposeR] = {keys_compose_r, "latin", "latin", false},
  [ComposeT] = {keys_compose_t, "latin", "latin", false},
  [ComposeP] = {keys_compose_p, "latin", "latin", false},
  [ComposeS] = {keys_compose_s, "latin", "latin", false},
  [ComposeD] = {keys_compose_d, "latin", "latin", false},
  [ComposeF] = {keys_compose_f, "latin", "latin", false},
  [ComposeG] = {keys_compose_g, "latin", "latin", false},
  [ComposeH] = {keys_compose_h, "latin", "latin", false},
  [ComposeJ] = {keys_compose_j, "latin", "latin", false},
  [ComposeK] = {keys_compose_k, "latin", "latin", false},
  [ComposeL] = {keys_compose_l, "latin", "latin", false},
  [ComposeZ] = {keys_compose_z, "latin", "latin", false},
  [ComposeX] = {keys_compose_x, "latin", "latin", false},
  [ComposeC] = {keys_compose_c, "latin", "latin", false},
  [ComposeV] = {keys_compose_v, "latin", "latin", false},
  [ComposeB] = {keys_compose_b, "latin", "latin", false},
  [ComposeN] = {keys_compose_n, "latin", "latin", false},
  [ComposeM] = {keys_compose_m, "latin", "latin", false},
  [ComposeMath] = {keys_compose_math, "latin", "latin", false},
  [ComposePunctuation] = {keys_compose_punctuation, "latin", "latin", false},
  [ComposeBracket] = {keys_compose_bracket, "latin", "latin", false},
...
static struct key keys_full[] = {
  {"Esc", "Esc", 1.5, Code, KEY_ESC, .scheme = 1},
  {"1", "!", 1.0, Code, KEY_1},
  {"2", "@", 1.0, Code, KEY_2},
  {"3", "#", 1.0, Code, KEY_3},
  {"4", "$", 1.0, Code, KEY_4},
  ...
  {"Backspace", "Backspace", 2.0, Code, KEY_BACKSPACE, .scheme = 1},
  {"", "", 0.0, EndRow},
